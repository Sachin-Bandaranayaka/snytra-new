                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {pageContent.features.items.map((item, index) => {
                            // --- DEBUGGING LOG ---
                            console.log(`AI Calling Feature: ${item.title}, svgPathD:`, item.svgPathD);
                            // --- END DEBUGGING LOG ---
                                    ...
                                    <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary mb-6">
                                        ...
                                        {isValidSvgPath ? (
                                            <svg
                                                ...
                                                className="h-6 w-6" // Adjusted size for this section's smaller icons
                                                fill="none"
                                                viewBox="0 0 24 24"
                                                stroke="currentColor"
                                            >
                                            ...
                                            // Fallback icon (a generic checkmark for features)
