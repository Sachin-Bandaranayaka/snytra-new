// src/components/editor/LeadGenerationEditor.tsx
'use client';
...
interface LeadGenerationEditorProps {
    initialContent: Partial<LeadGenerationData>;
    onChange: (newContent: Partial<LeadGenerationData>) => void;
}

export default function LeadGenerationEditor({ initialContent, onChange }: LeadGenerationEditorProps) {
    const [content, setContent] = useState<Partial<LeadGenerationData>>(initialContent);

    useEffect(() => { setContent(initialContent); }, [initialContent]);

    const handleUpdate = (newContent: Partial<LeadGenerationData>) => {
