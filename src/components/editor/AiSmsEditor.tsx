// src/components/editor/AiSmsEditor.tsx
'use client';
...
interface AiSmsEditorProps {
    initialContent: Partial<AiSmsData>;
    onChange: (newContent: Partial<AiSmsData>) => void;
}

export default function AiSmsEditor({ initialContent, onChange }: AiSmsEditorProps) {
    const [content, setContent] = useState<Partial<AiSmsData>>(initialContent);

    useEffect(() => { setContent(initialContent); }, [initialContent]);

    const handleUpdate = (newContent: Partial<AiSmsData>) => {
