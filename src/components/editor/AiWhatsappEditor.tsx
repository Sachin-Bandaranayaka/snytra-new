// src/components/editor/AiWhatsappEditor.tsx
'use client';
...
interface AiWhatsappEditorProps {
    initialContent: Partial<AiWhatsappData>;
    onChange: (newContent: Partial<AiWhatsappData>) => void;
}

export default function AiWhatsappEditor({ initialContent, onChange }: AiWhatsappEditorProps) {
    const [content, setContent] = useState<Partial<AiWhatsappData>>(initialContent);

    useEffect(() => { setContent(initialContent); }, [initialContent]);

    const handleUpdate = (newContent: Partial<AiWhatsappData>) => {
